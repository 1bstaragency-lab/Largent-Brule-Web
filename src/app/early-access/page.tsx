        ...
        {EARLY_ACCESS_PRODUCTS.map((p) => (
          <div key={p.handle} className="group block space-y-2">
            <Link href={`/product/${p.handle}`} className="block">
              <div
                className="aspect-[3/4] bg-white relative overflow-hidden flex items-center justify-center p-4 border border-transparent group-hover:border-neutral-200 transition-all duration-500 will-change-transform"
