...
const storyContent = [
  {
    title: "THE STUDY",
    text: "L'ARGENT BRÛLÉ IS A STUDY OF FORM, FUNCTION, AND THE TRANSIENCE OF MATERIALITY. FOUNDED ON THE PRINCIPLES OF CLINICAL MINIMALISM AND TECHNICAL PRECISION, EACH GARMENT IS A TESTAMENT TO THE PROCESS—A FUSION OF HISTORICAL SILHOUETTES AND FUTURISTIC TEXTILES.",
