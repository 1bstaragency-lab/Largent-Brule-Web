  ...
  return (
    <div className="min-h-screen bg-[#faf9f6] text-black flex flex-col items-center justify-center p-6 font-sans">
      ...
      <div className="w-full max-w-xl flex flex-col items-center justify-center space-y-24">
        ...
        <div className="w-full border border-neutral-200 px-6 py-8 flex items-center justify-center gap-4 sm:gap-10 text-2xl sm:text-5xl font-light tracking-[0.1em] sm:tracking-[0.2em]">
          ...
          >
            <div className="relative w-full">
              <input 
                ...
                className="w-full bg-transparent text-black text-[11px] font-light tracking-[0.3em] pb-3 outline-none border-b border-neutral-300 focus:border-black transition-colors placeholder:text-neutral-400 text-center"
                required
              />
            </div>
            <button 
              type="submit"
              name="submitBtn"
              className="w-full py-4 bg-transparent border border-black text-black text-[9px] font-bold tracking-[0.5em] uppercase hover:bg-black hover:text-[#faf9f6] transition-all duration-500"
            >
              REQUEST INVITATION
            </button>
          </form>
