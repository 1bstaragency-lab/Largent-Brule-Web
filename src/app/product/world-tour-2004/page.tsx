...
// Sizes wired to the Shopify "World Tour 2004 Tee" variants (made to order).
const SIZES = [
  { value: "S", label: "S", variantId: "47948422283415" },
  { value: "M", label: "M", variantId: "47948422316183" },
  { value: "L", label: "L", variantId: "47948422348951" },
  { value: "XL", label: "XL", variantId: "47948422381719" },
];
...
export default function WorldTour2004Page() {
        ...
        <div className="w-full px-4 py-6 max-w-2xl mx-auto">
          ...
          <div className="border-t border-neutral-200 pt-4 space-y-3">
            <p className="text-xs font-light text-neutral-600">
              Model is 6'1" and wears size XL. <button onClick={() => setShowSizeGuide(true)} className="underline cursor-pointer hover:opacity-60">SIZE GUIDE</button>
            </p>
            <p className="text-xs font-light text-neutral-600">
